            ...
            <CssBaseline />
                <Container maxWidth="lg">
                    <Grid container spacing={6}>
                        ...
                        <Grid item xs={5}  >
                            <Card>
                                <Basic onImageChange={(data) => this.handleUploadImageChange(data)}/>
                            </Card>
                            { this.state.image_file && !this.state.loading && <Card align = "center">
                                ...
                                <Stack
                                    ...
                                    justifyContent="center"
                                    >
                                    <Button variant="contained" align="left" color="primary" onClick={() =>  this.saveImage()} >
                                        닮은 포켓몬 찾기!
                                    </Button>
                                </Stack>
                                {this.state.dis_url && <Card align = "center">
                                    <CardHeader title={"당신을 닮은 포켓몬은? " + this.state.name} align = "center" style ={tempStyle}> </CardHeader>
                                    <img src={this.state.dis_url} alt="" width="224" height="224" align = "center"/> 
                                </ Card>}
                            </Card>}   
                        </Grid>              
                        <Grid item xs={6}>
                            <Card>
                                <CardContent>
                                    ...
                                    <Stack
                                        ...
                                        justifyContent="center"
                                        >
                                        <Button variant="contained" align="center" color="primary" onClick={() =>  this.turnCamera()} >
                                            Camera On/Off
                                        </Button>    
                                    </Stack>                                                 
                                </CardContent>
